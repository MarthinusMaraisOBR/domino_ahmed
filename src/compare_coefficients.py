...
forces = []
with open('test_output_exp6_50_test.txt', 'r') as f:
    current_run = {}
    for line in f:
        if 'Drag=' in line:
            parts = line.split()
...
df_forces.to_csv('coefficient_comparison6_50_test.csv', index=False)
print("\n✅ Full results saved to coefficient_comparison6.csv")